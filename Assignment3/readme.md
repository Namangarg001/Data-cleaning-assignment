...
Several customers place only one order, highlighting retention opportunities.
Sales performance varies greatly across customers.
Top customers can be targeted for loyalty and reward programs.
Project Structure
dataset/ screenshots/ SQL Scripts/ Insights.txt README.md